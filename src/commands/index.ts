...
export { default as cursorDown, cursorDownAlias } from './cursorDown'
...
export { default as cursorUp, cursorUpAlias } from './cursorUp'
...
export { default as subcategorizeOne, subCategorizeOneCommandAlias } from './subcategorizeOne'
